...
vector<Elektroscooter> ScooterRepo::readFromFile(const string& filename) {
...
void ScooterRepo::writeToFile(const vector<Elektroscooter>& scootersVector,const string& filename) {
...
void ScooterRepo::add(Elektroscooter &elektroscooter, const string& filename) {
    bool ok = false;
    auto auxVect = readFromFile(filename);
