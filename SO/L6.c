...
// fork_7.c
//
// Using variables which were defined in parent process,
// and passing status from child to parent process using exit() system call (man 2 exit).
//
...
int main(int argc, char* argv[])
{
    ...
    else                                // in parent process
    {
        ...
        sum = WEXITSTATUS(status);		// get the child true status (the least significant octet)
